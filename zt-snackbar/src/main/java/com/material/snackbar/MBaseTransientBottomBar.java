 ...
 */
public abstract class MBaseTransientBottomBar<B extends MBaseTransientBottomBar<B>> {
    ...
    /**
     * Animation modes that can be set on the {@link MBaseTransientBottomBar}.
     *
     * @hide
     */
    ...
    /**
     * Base class for {@link MBaseTransientBottomBar} callbacks.
     *
     * @param <B> The transient bottom bar subclass.
    ...
    public abstract static class BaseCallback<B> {
        ...
        /**
         * Called when the given {@link MBaseTransientBottomBar} has been dismissed, either through a
         ...
         * @see MBaseTransientBottomBar#dismiss()
         */
        ...
        /**
         * Called when the given {@link MBaseTransientBottomBar} is visible.
         *
         * @param transientBottomBar The transient bottom bar which is now visible.
         * @see MBaseTransientBottomBar#show()
         */
     ...
     *
     * @deprecated Use {@link MContentViewCallback} instead.
     */
    @Deprecated
    public interface ContentViewCallback extends MContentViewCallback {
    }
    ...
    private static final String TAG = MBaseTransientBottomBar.class.getSimpleName();
    ...
    static {
        handler = new Handler(Looper.getMainLooper(), new Handler.Callback() {
            ...
            public boolean handleMessage(@NonNull Message message) {
                switch (message.what) {
                    case MSG_SHOW:
                        ((MBaseTransientBottomBar) message.obj).showView();
                        return true;
                    case MSG_DISMISS:
                        ((MBaseTransientBottomBar) message.obj).hideView(message.arg1);
                        return true;
                    default:
                        return false;
                }
    ...
    @NonNull
    private final MContentViewCallback contentViewCallback;
    ...
    private final Runnable bottomMarginGestureInsetRunnable =
            new Runnable() {
                ...
                public void run() {
                    ...
                    Log.w(TAG, ">>>> " + marginParams.bottomMargin);
                    view.requestLayout();
                }
            };
     ...
     */
    protected MBaseTransientBottomBar(
...
//        ThemeEnforcement.checkAppCompatTheme(context);
        ...
        if (content instanceof MSnackbarContentLayout) {
            ((MSnackbarContentLayout) content).updateActionTextColorAlphaIfNeeded(view.getActionTextColorAlpha());
        }
    ...
    private void updateMargins() {
        ...
        Log.w(TAG, ">>> " + marginParams.bottomMargin + " - " + extraBottomMargin);
        view.requestLayout();
    ...
    protected int getSnackbarBaseLayoutResId() {
        return R.layout.m_design_layout_snackbar;
    }
    ...
    /**
     * Returns the anchor view for this {@link MBaseTransientBottomBar}.
     *
    ...
    /**
     * Sets the view the {@link MBaseTransientBottomBar} should be anchored above.
     */
    @NonNull
    public B setAnchorView(@Nullable View anchorView) {
        MViewUtils.removeOnGlobalLayoutListener(this.anchorView, anchorViewLayoutListener);
        this.anchorView = anchorView;
        MViewUtils.addOnGlobalLayoutListener(this.anchorView, anchorViewLayoutListener);
        return (B) this;
    }

    /**
     * Sets the view the {@link MBaseTransientBottomBar} should be anchored above by id.
     *
     ...
     * MBaseTransientBottomBar} will recalculate and update its position when the position of the
    ...
    /**
     * Returns the {@link MBaseTransientBottomBar}'s context.
     */
    @NonNull
    ...
    /**
     * Returns the {@link MBaseTransientBottomBar}'s view.
     */
    @NonNull
    public View getView() {
        return view;
    ...
    /**
     * Show the {@link MBaseTransientBottomBar}.
     */
    public void show() {
        MSnackbarManager.getInstance().show(getDuration(), managerCallback);
    }

    /**
     * Dismiss the {@link MBaseTransientBottomBar}.
     */
    public void dismiss() {
    ...
    protected void dispatchDismiss(@BaseCallback.DismissEvent int event) {
        MSnackbarManager.getInstance().dismiss(managerCallback, event);
    }
    ...
    /**
     * Return whether this {@link MBaseTransientBottomBar} is currently being shown.
     */
    public boolean isShown() {
        return MSnackbarManager.getInstance().isCurrent(managerCallback);
    }

    /**
     * Returns whether this {@link MBaseTransientBottomBar} is currently being shown, or is queued to
     * be shown next.
     */
    public boolean isShownOrQueued() {
        return MSnackbarManager.getInstance().isCurrentOrNext(managerCallback);
    }

    @NonNull
    MSnackbarManager.Callback managerCallback =
            new MSnackbarManager.Callback() {
                @Override
                public void show() {
                    handler.sendMessage(handler.obtainMessage(MSG_SHOW, MBaseTransientBottomBar.this));
                }

                @Override
                public void dismiss(int event) {
                    handler.sendMessage(
                            handler.obtainMessage(MSG_DISMISS, event, 0, MBaseTransientBottomBar.this));
                }
            };
    ...
    final void showView() {
        ...
        this.view.setOnLayoutChangeListener(new OnLayoutChangeListener() {
            ...
            public void onLayoutChange(View view, int left, int top, int right, int bottom) {
                MBaseTransientBottomBar.this.view.setOnLayoutChangeListener(null);
                MBaseTransientBottomBar.this.showViewImpl();
            }
        });
    }
    ...
    private void setUpBehavior(CoordinatorLayout.LayoutParams lp) {
        ...
        if (behavior instanceof MBaseTransientBottomBar.Behavior) {
                    ...
                    public void onDragStateChanged(int state) {
                        switch (state) {
                            ...
                            case SwipeDismissBehavior.STATE_SETTLING:
                                ...
                                MSnackbarManager.getInstance().pauseTimeout(managerCallback);
                                break;
                            case SwipeDismissBehavior.STATE_IDLE:
                                // If the view has been released and is idle, restore the timeout
                                MSnackbarManager.getInstance().restoreTimeoutIfPaused(managerCallback);
                                break;
                            default:
    ...
    private ValueAnimator getAlphaAnimator(float... alphaValues) {
        ...
        animator.setInterpolator(MAnimationUtils.LINEAR_INTERPOLATOR);
    ...
    private ValueAnimator getScaleAnimator(float... scaleValues) {
        ...
        animator.setInterpolator(MAnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
        animator.addUpdateListener(
                new AnimatorUpdateListener() {
                    @Override
                    public void onAnimationUpdate(@NonNull ValueAnimator valueAnimator) {
    ...
    private void startSlideInAnimation() {
        ...
        animator.setInterpolator(MAnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
    ...
    void onViewShown() {
        MSnackbarManager.getInstance().onShown(managerCallback);
        if (callbacks != null) {
    ...
    void onViewHidden(int event) {
        ...
        MSnackbarManager.getInstance().onDismissed(managerCallback);
        if (callbacks != null) {
            // Notify the callbacks. Do that from the end of the list so that if a callback
            // removes itself as the result of being called, it won't mess up with our iteration
            int callbackCount = callbacks.size();
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        private MBaseTransientBottomBar.OnLayoutChangeListener onLayoutChangeListener;
        private MBaseTransientBottomBar.OnAttachStateChangeListener onAttachStateChangeListener;
        @AnimationMode
...
//            backgroundOverlayColorAlpha =a.getFloat(R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1);
//            setBackgroundTintList(MaterialResources.getColorStateList(context, a, R.styleable.SnackbarLayout_backgroundTint));
//            setBackgroundTintMode(MViewUtils.parseTintMode(a.getInt(R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
//            actionTextColorAlpha = a.getFloat(R.styleable.SnackbarLayout_actionTextColorAlpha, 1);
        ...
        void setOnLayoutChangeListener(
                MBaseTransientBottomBar.OnLayoutChangeListener onLayoutChangeListener) {
            this.onLayoutChangeListener = onLayoutChangeListener;
        }

        void setOnAttachStateChangeListener(
                MBaseTransientBottomBar.OnAttachStateChangeListener listener) {
    ...
    /**
     * Behavior for {@link MBaseTransientBottomBar}.
     */
    public static class Behavior extends SwipeDismissBehavior<View> {
        ...
        private void setBaseTransientBottomBar(
                @NonNull MBaseTransientBottomBar<?> baseTransientBottomBar) {
    ...
    public static class BehaviorDelegate {
        private MSnackbarManager.Callback managerCallback;
