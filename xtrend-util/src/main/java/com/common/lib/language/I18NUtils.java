...
//            Log.i(TAG, "修改方法2-1：" + resources.getConfiguration().locale);
//            Log.i(TAG, "修改方法2-2：" + mContext.getResources().getConfiguration().locale);
        }
//        Log.i(TAG, "修改语言后：" + mContext.getResources().getConfiguration().locale);
