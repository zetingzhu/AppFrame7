...
//        if (view.getWidth() <=0
//                && maxWidth > 0) {
//             //getWidth() is wrap_content
//            targetWidth = maxWidth - view.getPaddingLeft() - view.getPaddingRight();
//        }
//        if (targetWidth <= 0) {
//            return;
//        }
        ...
        view.setTextSize(TypedValue.COMPLEX_UNIT_PX, (int) size);
    }
