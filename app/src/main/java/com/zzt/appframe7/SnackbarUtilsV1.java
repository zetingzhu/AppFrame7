 ...
 */
public final class SnackbarUtilsV1 {
    ...
    private SnackbarUtilsV1(final View parent) {
        setDefault();
        this.view = parent;
    }
     ...
     * @return the single {@link SnackbarUtilsV1} instance
     */
    public static SnackbarUtilsV1 with(@NonNull final View view) {
        return new SnackbarUtilsV1(view);
    }
     ...
     * @return the single {@link SnackbarUtilsV1} instance
     */
    public SnackbarUtilsV1 setMessage(@NonNull final CharSequence msg) {
        this.message = msg;
        return this;
    }
     ...
     * @return the single {@link SnackbarUtilsV1} instance
     */
    public SnackbarUtilsV1 setMessageColor(@ColorInt final int color) {
     ...
     * @return the single {@link SnackbarUtilsV1} instance
     */
    public SnackbarUtilsV1 setBgColor(@ColorInt final int color) {
        this.bgColor = color;
        return this;
    }
     ...
     * @return the single {@link SnackbarUtilsV1} instance
     */
    public SnackbarUtilsV1 setBgResource(@DrawableRes final int bgResource) {
     ...
     * @return the single {@link SnackbarUtilsV1} instance
     */
    public SnackbarUtilsV1 setDuration(@Duration final int duration) {
     ...
     * @return the single {@link SnackbarUtilsV1} instance
     */
    public SnackbarUtilsV1 setAction(@NonNull final CharSequence text,
     ...
     */
    public SnackbarUtilsV1 setBottomMargin(@IntRange(from = 1) final int bottomMargin) {
...
//                topSnackBarCoordinatorLayout.setBackgroundColor(Color.parseColor("#FF0000"));
//                topSnackBarCoordinatorLayout.setPadding(20 , 50,20,20);
        ...
        if (isShowTop) {
//            snackbarView.setPadding(40, 140, 40, 40);
