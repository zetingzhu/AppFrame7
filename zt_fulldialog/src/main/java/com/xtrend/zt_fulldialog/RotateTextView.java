 ...
 * 带倾斜角度的文字
 * <p>
 * adb shell am start -W -n com.rynatsa.xtrendspeed_debug/com.trade.eight.moudle.home.activity.LoadingActivity
 * Starting: Intent { cmp=com.rynatsa.xtrendspeed_debug/com.trade.eight.moudle.home.activity.LoadingActivity }
 * Status: ok
...
public class RotateTextView extends View {
    ...
    // 圆角角度
    private float mSlantedRadius = 0;
    ...
    public RotateTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init(AttributeSet attrs) {
        ...
        mSlantedRadius = array.getDimension(R.styleable.SlantedTextView_slantedRadius, mSlantedRadius);
    ...
    private Path getModeRightTrianglePath(Path path, int w, int h) {
        if (mSlantedRadius > 0) {
            path.lineTo(w - mSlantedRadius, 0);
            path.arcTo(new RectF(w - mSlantedRadius, 0, w, mSlantedRadius), -90, 90);
            path.lineTo(w, mSlantedRadius);
            path.lineTo(w, h);
        } else {
            path.lineTo(w, 0);
            path.lineTo(w, h);
    ...
    public RotateTextView setText(int res) {
    ...
    public RotateTextView setSlantedBackgroundColor(int color) {
    ...
    public RotateTextView setTextColor(int color) {
        mTextColor = color;
        mTextPaint.setColor(mTextColor);
        postInvalidate();
        return this;
     ...
     * @return this
     */
    public RotateTextView setMode(int mode) {
    ...
    public RotateTextView setTextSize(int size) {
        this.mTextSize = size;
        mTextPaint.setTextSize(mTextSize);
        postInvalidate();
        return this;
     ...
     * @return this
     */
    public RotateTextView setSlantedLength(int length) {
